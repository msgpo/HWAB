##########
# Win10 / Windows Server 2016 Initial script
# 
# This script isn't a so called 'debloat' script it's
# a script which disables and uninstalls the stuff I normally
# uninstall after a fresh Windows/Server installation. 
#
# Author: CHEF-KOCH
# Version: 0.6
# Source: 
...
# Uninstall OneDrive - Not applicable to Windows Server
...
# Install OneDrive - Not applicable to Windows Server
...
# In case you have removed them for, you can try to restore the files using installation medium as follows
